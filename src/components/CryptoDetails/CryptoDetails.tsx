...
import {DetailCoin, DetailRoot, History, HistoryData, Link} from "../../../types/types";
...
export const CryptoDetails = () => {
  ...
  // const { coinHistory }: {coinHistory: HistoryData} = useGetCryptoHistoryQuery({ coinId, timeperiod });
  const cryptoDetails: DetailCoin | undefined = data?.data.coin;
  ...
  return (
      <Col className="coin-detail-container">
        ...
        {/*<LineChart coinHistory={coinHistory} currentPrice={Number(millify(cryptoDetails?.price))} coinName={cryptoDetails?.name as string} />*/}
